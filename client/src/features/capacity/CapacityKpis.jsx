...
export default function CapacityKpis({ data }) {
  ...
  const cards = [
    ...
    },
    {
      ...
      // El detalle del cálculo va a la vista: días trabajados sobre el total
      // posible (colaboradores que comisionan x días del mes).
      sub: `${resumen.dias_trabajados || 0} de ${(resumen.colaboradores_activos || 0) * (resumen.dias_del_mes || 0)} días posibles`,
      iconBg: 'bg-pink-50 text-[#D81B60]',
